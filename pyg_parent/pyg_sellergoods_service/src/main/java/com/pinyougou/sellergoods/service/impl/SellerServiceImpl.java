...
import com.pyg_dao.mapper.TbSellerMapper;
...
public class SellerServiceImpl implements SellerService {
     ...
     */
    @Override
    public List<TbSeller> findAll(String name, String nickName) {
    ...
    /**
     * @param sellerId 商家id
     * @param start    状态0未审核，1已审核，2未通过审核，3关闭商家
     */
    @Override
    public void updateStatus(String sellerId, String start) {
        //根据主键查询用户信息
        TbSeller tbSeller = sellerMapper.selectByPrimaryKey(sellerId);
        //修改用户信息
        tbSeller.setStatus(start);
