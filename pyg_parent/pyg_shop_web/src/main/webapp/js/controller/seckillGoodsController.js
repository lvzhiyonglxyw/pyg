app.controller("seckillGoodsController", function ($scope, $controller, uploadService, goodsService, seckillGoodsService, itemService) {
    ...
    $scope.$watch("entity.goodsId", function (newValue, oldValue) {
        ...
        itemService.findByGoodsId(newValue).success(
            function (response) {
    ...
    $scope.search = function (pageNum, pageSize) {
        seckillGoodsService.finBySellerId(pageNum, pageSize).success(
            function (response) {
